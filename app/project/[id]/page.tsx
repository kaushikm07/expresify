    ...
    return (
        <Modal>
            <section className="flexBetween gap-y-8 max-w-4xl max-xs:flex-col w-full">
                ...
                {/* If logged in user is the user who created the project then we can see the options of add and delete */}
            ...
            <section className="flexCenter w-full gap-8 mt-28">
                <span className="max-w-sm w-full h-0.5 bg-light-white-200" />
